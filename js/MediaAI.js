...
- 1. 落地 IP: my.ippure.com (红框格式 + 信息图标)
- 1. 流媒体/AI: 去除树状符，改为专属图标
- 1. 整体图标: 紫色波浪印章
- 
- 修复内容：
- - 修复 ChatGPT/Claude 等检测逻辑，支持重定向状态码
- - 优化所有流媒体检测的状态码判断
    */
...
// Disney+ 如果能访问到 preview 页或正常页面都算成功
return (res.status >= 200 && res.status < 400) ? “✅” : “❌”;
} catch {
return “🚫”;
}
...
try {
let res = await fetch(“https://claude.ai”);
// 支持重定向状态码
return (res.status >= 200 && res.status < 400) ? “✅” : “❌”;
} catch {
return “🚫”;
